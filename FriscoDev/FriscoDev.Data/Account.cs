...
namespace FriscoDev.Data
{
    ...
    public partial class Account
    {
        ...
        public Nullable<int> UR_TYPE_ID { get; set; }
        public Nullable<bool> UR_ACTIVE { get; set; }
        public Nullable<System.DateTime> UR_ADDTIME { get; set; }
        public Nullable<System.DateTime> UR_UPTIME { get; set; }
        public string UR_STATUS { get; set; }
        public Nullable<bool> IS_ADMIN { get; set; }
        public string IMG_URL { get; set; }
        public string TIME_ZONE { get; set; }
        public string ZoomLevel { get; set; }
        public Nullable<int> MessageDays { get; set; }
    }
}
